        ...
        <Fade bottom duration={1000} distance="40px">
          <div className="contact-heading-div">
            ...
            <div className="contact-heading-text-div">
              ...
              <h1 className="address-heading-text" style={{ color: theme.text, marginTop:"60px" }}>
                {addressSection["title"]}
              </h1>
              <p className="contact-header-detail-text" style={{ color: theme.secondaryText,  marginTop:"20px" }}>
